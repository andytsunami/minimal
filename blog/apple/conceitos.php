...
<div class="container">
  ...
  <div id="blog_breadcrumbs">
    <div class="col s8">
      ...
      <a href="#!" class="breadcrumb">Apple Design</a>
...
<!-- Sidemenu -->
  ...
  <div class="col s3" id="side_menu">
    ...
    <li>
     ...
     <li>
      <div class="collapsible-header active">Apple Design</div>
      <div class="collapsible-body">
      <a href="historia.php" class="collection-item">História</a>
      <a href="conceitos.php" class="collection-item active">Conceitos</a>
      <a href="apicacoes.php" class="collection-item">Aplicações</a>
      </div>
    </li>
    <li>
