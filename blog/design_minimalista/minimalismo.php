...
<div class="container">
  ...
  <div id="blog_breadcrumbs">
   <div class="col s8">
      ...
      <a href="minimalismo.php" class="breadcrumb">Minimalismo em User Interfaces</a>
    </div>
...
<!-- Sidemenu -->
  ...
  <div class="col s3" id="side_menu">
    ...
    <li>
      ...
      <a href="minimalismo.php" class="collection-item active">Minimalismo em User Interfaces</a>
