...
<div class="container">
  ...
  <div id="blog_breadcrumbs">
    <div class="col s8">
      ...
      <a href="#!" class="breadcrumb">User Experience</a>
      <a href="aplicacoes.php" class="breadcrumb">Aplicações</a>
    </div>
...
<!-- Sidemenu -->
  ...
  <div class="col s3" id="side_menu">
    ...
    <li>
      <div class="collapsible-header active">User Experience</div>
      <div class="collapsible-body">
      <a href="o_que_e.php" class="collection-item">O que é</a>
      <a href="conceitos.php" class="collection-item">Conceitos</a>
      <a href="como.php" class="collection-item">Como utilizar</a>
      <a href="aplicacoes.php" class="collection-item active">Aplicações</a>
      </div>
    </li>
    <li>
