...
<div class="container">
  ...
  <div id="blog_breadcrumbs">
    <div class="col s8">
      ...
      <a href="vantagens.php" class="breadcrumb">Vantagens</a>
    </div>
...
<div class="row">
  ...
  <h4>Vantagens e Desvantagens do Flat Design</h4>
<p>Abaixo, preparamos um infográfico com as principais vantagens e desvantagens do Flat Design</p>
<br>

<img src="info.jpg" width="600px">
</p><br /><br /><br />
  </div>
...
<!-- Sidemenu -->
  ...
  <div class="col s3" id="side_menu">
    ...
    <li>
      ...
      <a href="ske.php" class="collection-item">Skeuemorphic vs Flat</a>
      <a href="vantagens.php" class="collection-item active">Vantagens</a>
      </div>
    </li>
    <li>
